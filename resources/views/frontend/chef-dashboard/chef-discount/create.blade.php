            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Promocode</a></li>
                    </ol>
                </div>
            </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    {{ Form::open(['url' => route('chef-discount.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmPromocode', 'id' => 'frmPromocode','class'=>"form-main"]) }}
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="promocode" id="promocode" value="" placeholder="" required="" autocomplete="off">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group mb-2">
                                                        <input type="number" class="form-control" name="discount" id="discount" value="" required="" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control" name="total_coupons" id="total_coupons" value="" placeholder="" required="" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control" id="minimum_order_value" name="minimum_order_value" placeholder="" required="" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input name="start_date" class="datepicker-default form-control" id="start_date" required="" autocomplete="off" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <input name="expired_date" class="datepicker-default form-control" id="expired_date" required="" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-warning" name="btnSubmit" >Add</button>
