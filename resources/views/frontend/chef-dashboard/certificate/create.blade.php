            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"> {{__('sentence.addcerti') }}</a></li>
                    </ol>
                </div>
            </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                 <div class="basic-form">
                                      {{ Form::open(['url' => route('certificate.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmCertificate', 'id' => 'frmCertificate','class'=>"form-main"]) }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label"> {{__('sentence.from') }}
                                                                <span class="text-danger">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="certi_from" id="from" autocomplete="off" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                 <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label"> {{__('sentence.to') }}
                                                                <span class="text-danger">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="certi_to" id="to"  required="" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
