            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('sentence.addblog') }}</a></li>
                    </ol>
                </div>
            </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                 <div class="card-title">
                                    <h4>{{ __('sentence.addblog') }}</h4>
                                </div>
                            </div>
                            <div class="card-body"><div class="basic-form">
                                    {{ Form::open(['url' => route('blog.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmBlog', 'id' => 'frmBlog','class'=>"form-main"]) }}
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">{{ __('sentence.title') }}
                                                        <span class="text-danger">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="title" id="title" placeholder="{{ __('sentence.entdesc') }} " required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 custom-file">
                                                <input type="file" name="image" id="image" onchange="previewImage(this)" accept="image/*" class="custom-file-input" required="">
