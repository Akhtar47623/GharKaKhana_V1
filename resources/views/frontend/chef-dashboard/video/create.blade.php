            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('sentence.addvideo') }}</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                 <div class="card-title">
                                    <h4>{{ __('sentence.addvideo') }}</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    {{ Form::open(['url' => route('video.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmVideo', 'id' => 'frmVideo','class'=>"form-main"]) }}
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">{{ __('sentence.title') }}
                                                        <span class="text-danger">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="title" id="title" placeholder="{{ __('sentence.entertitle') }}" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="video_link" id="video_link" placeholder="{{ __('sentence.entvidl') }} " required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
