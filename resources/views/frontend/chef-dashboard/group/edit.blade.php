        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('group.index')}}">{{__('sentence.menugroup') }}</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">{{__('sentence.editgroup') }}</a></li>
                    </ol>
                </div>
            </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <h4>{{__('sentence.editgroup') }}</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    {{ Form::open(['url' => route('group.update', $groupData->id), 'method'=>'PATCH', 'files'=>true, 'name' => 'frmGroup', 'id' => 'frmGroup','class'=>"form-main"]) }}
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label>{{__('sentence.gnm') }}<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="group_name" id="group_name" placeholder="{{__('sentence.entgnm') }}" required="" value="{{$groupData->group_name?? '' }}">
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" id="option" name="option" required="">
                                                            ...
                                                            <option value="M" {{$groupData->option=="M"?'selected':''}}>{{__('sentence.multi') }}</option>
                                                            <option value="S" {{$groupData->option=="S"?'selected':''}}>{{__('sentence.sing') }}</option>
                                                        </select>
                                            </div>
                                             <div class="form-group col-md-4">
                                                <label>{{__('sentence.requ') }}<span class="text-danger">*</span></label>
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="togBtn" name="required" {{$groupData->required=="1"?'checked':''}}>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <br><button type="submit" class="btn btn-warning" name="btnSubmit">{{__('sentence.update') }}</button>
