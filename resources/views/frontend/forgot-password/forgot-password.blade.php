...
<body>
                    ...
                    <div class="login-right-wrap">
                        ...
                        <div class="login-top">
                            <div class="login-form-sec">
                             {{ Form::open(['url' => route('password-recovery'), 'method'=>'POST', 'files'=>true, 'name' => 'frmForgotPassword', 'id' => 'frmForgotPassword','class'=>"form-main"]) }}
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="form-wrap">
                                            <button type="submit" name="btnSubmit" id="btnSubmit">{{__('sentence.send') }}</button>
    ...
    <script type="text/javascript" src="{{ asset('public/frontend/js/pages/forgot-password.js')}}"></script>
    <!--scripts ends here-->
</body>
</html>