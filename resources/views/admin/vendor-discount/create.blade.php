        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    {{ Form::open(['url' => route('vendor-discount.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmVendorDiscount', 'id' => 'frmVendorDiscount']) }}
                     <div class="box-body">
                        <div class="row"> 
                             ...
                             <div class="form-group col-sm-6">
                                {{ Form::label('vendor_discount','Vendor Discount') }}
                                 <div class="input-group">
                                     {{ Form::text('vendor_discount', old('vendor_discount'), ["required","class"=>"form-control","placeholder"=>'Enter Company Discount',"id"=>"vendor_discount","name"=>"vendor_discount"]) }}
