        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    {{ Form::model(null, ['route' => 'roles.store', 'files' => true, 'role' => 'form', 'id'=>'frmRoles', 'method'=>'post']) }}
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                {{ Form::label('name', "Name") }}
                                {{ Form::text('name', old('name'), ["class"=>"form-control","placeholder"=>"Name","id"=>"name","name"=>"name","required"]) }}
                                @if ($errors->has('name'))
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                         {{ Form::button('Submit',['type'=>'submit','class'=>'btn btn-primary','id'=>'btnSubmit', 'data-text'=>'Submit', 'data-loading-text'=>'<i class="fa fa-spinner fa-spin"></i> loading'])}}
