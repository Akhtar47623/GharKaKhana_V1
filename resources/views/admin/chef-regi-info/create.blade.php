                ...
                <div class="box box-primary">
                    <div class="box-header with-border content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="{{ route('chef-registration-info.index') }}"> {{ Config::get('constants.title.chef_reg_info') }} </a></li>
                            <li><a href="#">{{ $title }}</a></li>
                        </ol>
                    </div>
                    {{ Form::open(['url' => route('chef-registration-info.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmChefRegInfo', 'id' => 'frmChefRegInfo']) }}
                     <div class="box-body">
                        <div class="row"> 
                           ...
                           <div class=" form-group col-sm-4">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                {{ Form::select('user_type',["1"=>"Home Chef","2"=>"Catering"], old('user_type'),["required","class"=>"form-control","placeholder"=>'Select User Type',"id"=>"user_type","name"=>"user_type"]) }}
                            </div>
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                {{Form::textarea('description',old('description'), ["required",'class'=>'form-control','rows'=>3,"id"=>"summary_ckeditor","name"=>"summary_ckeditor"])}}                             
                            </div>
