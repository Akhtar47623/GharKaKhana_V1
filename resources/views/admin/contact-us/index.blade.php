            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border content-header">
                        <h3>{{ $title }}  
                            @if($permission::checkActionPermission('delete_contactus'))
                            ...
                            data-action="{{ route('contactusmultidelete') }}"
                ...
                <div class="box-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                @if($permission::checkActionPermission('delete_contactus'))
                                <button id="country" type="button" title="Delete" rel="tooltip" class="btn  btn-danger remove"  data-id="{{($value->id)}}"  data-action="{{route('contact-us.destroy', $value->id)}}" data-message="{{Config::get('constants.message.confirm')}}"><i class="fa fa-trash"></i></button>
                                @endif
                            </td>
                        @endforeach
                        @endif
...
<script src="{{ asset('public/frontend/js/pages/contactus.js') }}"></script>
@stop