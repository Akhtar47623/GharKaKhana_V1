        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    {{ Form::open(['url' => route('taxes.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmTaxes', 'id' => 'frmTaxes']) }}
                     <div class="box-body">
                        <div class="row"> 
                        ...
                        <div class="row">
                             <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">                                
                                    {{ Form::number('chef_commission', old('chef_commission'), ["required","class"=>"form-control","placeholder"=>'Enter Chef Commission',"id"=>"chef_commission","name"=>"chef_commission","maxlength"=>100]) }}
                             ...
                             <div class=" form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    {{ Form::number('delivery_commission', old('delivery_commission'), ["required","class"=>"form-control","placeholder"=>'Enter Chef Commission',"id"=>"delivery_commission","name"=>"delivery_commission","maxlength"=>100]) }}                         
                                    <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class=" form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    {{ Form::number('service_fee_base', old('service_fee_base'), ["required","class"=>"form-control","placeholder"=>'Enter Service Fee Base',"id"=>"service_fee_base","name"=>"service_fee_base"]) }}
                                </div>                                
                            </div>
                            <div class=" form-group col-sm-6">
                                {{ Form::label('service_fee_per','Service Fee') }}
                                <div class="input-group">
                                    {{ Form::number('service_fee_per', old('service_fee_per'), ["required","class"=>"form-control","placeholder"=>'Enter Service Fee Base',"id"=>"service_fee_per","name"=>"service_fee_per"]) }}  
                                    <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                                </div>                              
                            </div>
                        </div>
                        <div class="row">
                            <div class=" form-group col-sm-6">
                                {{ Form::label('Tax','Tax') }}
                                <div class="input-group">
                                    {{ Form::number('tax', old('tax'), ["required","class"=>"form-control","placeholder"=>'Enter  Tax',"id"=>"tax","name"=>"tax","maxlength"=>100,'min' => '0.00']) }}                                
                                    <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                                </div>
                            </div>
                            <div class=" form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    {{ Form::number('cc_fees', old('cc_fees'), ["required","class"=>"form-control","placeholder"=>'Enter  Credit Card',"id"=>"cc_fees","name"=>"cc_fees","maxlength"=>100,'min' => '0.00']) }}                           
                                    <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                                </div>     
                            </div>
                        </div>
                        <div class="row">
                            <div class=" form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    {{ Form::number('house', old('house'), ["required","class"=>"form-control","placeholder"=>'Enter  House',"id"=>"house","name"=>"house","maxlength"=>100]) }} 
                                    <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                                </div>                               
                            </div>
