        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    {{ Form::open(['url' => route('city.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmCity', 'id' => 'frmCity']) }}
                     <div class="box-body">
                        <div class="row"> 
                            <div class="form-group col-sm-6">
                                {{ Form::label('country_id','Country') }}
                                {{ Form::select('country_id',!empty($countries) ? $countries : [], old('country_id'),["required","class"=>"form-control select2","style"=>"width:100%","placeholder"=>'-----Select Country------',"id"=>"country_id","name"=>"country_id"]) }}
                            </div>
                            <div class=" form-group col-sm-6">
                        ...
                        <div class="row">
                            <div class=" form-group col-sm-6">
                                ...
                                {{ Form::text('name', old('name'), ["required","class"=>"form-control","placeholder"=>'Enter City Name',"id"=>"name","name"=>"name","maxlength"=>100]) }}
