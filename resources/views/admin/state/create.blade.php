        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    {{ Form::open(['url' => route('state.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmState', 'id' => 'frmState']) }}
                     <div class="box-body">
                        <div class="row"> 
                            ...
                            <div class=" form-group col-sm-6">
                                ...
                                {{ Form::text('name', old('name'), ["required","class"=>"form-control","placeholder"=>'Enter State Name',"id"=>"name","name"=>"name","maxlength"=>100]) }}
                            </div>
                        </div>
                    </div>
