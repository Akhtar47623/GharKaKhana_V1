                ...
                <div class="box box-primary">
                    <div class="box-header with-border content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="{{ route('country.index') }}"> {{ Config::get('constants.title.countries') }} </a></li>
                            <li><a href="#">{{ $title }}</a></li>
                        </ol>
                    </div>
                    {{ Form::open(['url' => route('country.store'), 'method'=>'POST', 'files'=>true, 'name' => 'frmCountry', 'id' => 'frmCountry']) }}
                     <div class="box-body">
                        <div class="row"> 
                            <div class="form-group col-sm-6">
                                {{ Form::label('name','Name') }}
                                {{ Form::text('name', old('name'), ["required","class"=>"form-control","placeholder"=>'Enter Country Name',"id"=>"name","name"=>"name","maxlength"=>100]) }}
                            </div>
                            <div class=" form-group col-sm-6">
                                {{ Form::label('sortname','Sort Name') }}
                                {{ Form::text('sortname', old('sortname'), ["required","class"=>"form-control","placeholder"=>'Enter Country Sort Name',"id"=>"sortname","name"=>"sortname","minlength"=>"2","maxlength"=>"2"]) }}
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                {{ Form::number('phoneCode', old('phoneCode'), ["required","class"=>"form-control","placeholder"=>'Enter Country Phone Code',"id"=>"phoneCode","name"=>"phoneCode","min"=>1]) }}                                
                            </div>
                            <div class=" form-group col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class=" form-group col-sm-6">
                                ...
                                {{ Form::text('symbol', old('symbol'), ["required","class"=>"form-control","placeholder"=>'Enter Currency Symbol',"id"=>"symbol","name"=>"symbol","minlength"=>"2","maxlength"=>"2"]) }}
